...
import com.indrive.clone.data.model.Ride
import com.indrive.clone.data.model.RideStatus
...
class RideHistoryAdapter(
    ...
    inner class RideViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private fun showReceiptDialog(ride: Ride) {
            val dialog = BottomSheetDialog(itemView.context, R.style.Widget_InDrive_BottomSheet)
