...
import com.indrive.clone.data.local.LocalPreferences
import com.indrive.clone.data.repository.MockDataRepository
import com.indrive.clone.utils.BiometricHelper
                ...
                .setPositiveButton("Verify & Delete") { _, _ ->
                    ...
                    BiometricHelper.showBiometricPrompt(
                        ...
                        onSuccess = {
                            ...
                            val intent = android.content.Intent(requireContext(), com.indrive.clone.ui.auth.AuthActivity::class.java)
