...
class HomeFragment : Fragment() {
    ...
    private fun setupSavedPlaceButtons(view: View) {
        ...
        val home = savedPlaces.firstOrNull { it.type == com.indrive.clone.data.model.PlaceType.HOME }
        val work = savedPlaces.firstOrNull { it.type == com.indrive.clone.data.model.PlaceType.WORK }
