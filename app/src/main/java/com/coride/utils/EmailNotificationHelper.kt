...
import com.coride.data.model.User
...
object EmailNotificationHelper {
    ...
    /**
     * Send a critical SOS emergency alert to the admin with GPS coordinates and live tracking link.
     */
                ...
                <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; border: 2px solid #BA1A1A; overflow: hidden;">
                    ...
                    <div style="padding: 24px;">
                        ...
                        <div style="margin: 24px 0; text-align: center;">
                            <a href="$liveLink" style="background-color: #000000; color: #ffffff; padding: 16px 32px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block; font-size: 16px; border: 2px solid #ffffff; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
                                🛰️ OPEN LIVE TRACKER
                            </a>
                        </div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
                            ...
                            <tr style="background-color: #F8F9FA;"><td style="padding: 8px; border-bottom: 1px solid #ddd; color: #777;">📍 Static Map</td><td style="padding: 8px; border-bottom: 1px solid #ddd;"><a href="$googleMapsLink" style="color: #BA1A1A; font-weight: bold;">VIEW ON GOOGLE MAPS</a></td></tr>
                            <tr><td style="padding: 8px; color: #777;">Ride ID</td><td style="padding: 8px; font-family: monospace;">$rideId</td></tr>
                        </table>
                    </div>
                    <div style="background-color: #FFF3F3; padding: 12px; text-align: center; color: #BA1A1A; font-size: 12px; font-weight: bold;">
                        ⚠️ This is a Priority 1 Emergency Alert from CoRide Safety Systems.
                    </div>
                </div>
            </body>
            </html>
